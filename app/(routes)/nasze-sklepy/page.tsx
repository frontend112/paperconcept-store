  ...
  return (
    <>
      ...
      <section className="p-[10%]">
        <h3 className="uppercase font-mono pb-4">PaperConcept to także sklepy stacjonarne!</h3>
        <ul className="flex items-center flex-col lg:grid lg:grid-cols-2">
          {shops.map(({ name, address, city }) => (<li className="w-[80vw] h-[80vw] lg:w-[30vw] lg:h-[calc(40vw/2)] lg:pt-12" key={name}>
